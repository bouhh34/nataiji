...
assert('PWA cache version current', /nataiji-shell-v42/.test(sw));
...
assert('More page assets are loaded last', /more-page-v1\.css\?v=2/.test(index) && /more-page-v1\.js\?v=3/.test(index));
