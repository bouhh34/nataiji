...
assert('PWA cache version current', /nataiji-shell-v53/.test(sw));
...
assert('More page assets are loaded', /more-page-v1\.css\?v=3/.test(index) && /more-page-v1\.js\?v=6/.test(index));
