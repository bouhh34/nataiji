...
function fillFinalTable(table){
  ...
  table.innerHTML=`<thead><tr>
    ...
    ${subjects.map(s=>`<th class="final-sub"><div class="final-vertical"><span>${esc(s?.[0]||'')}</span><small dir="ltr">/${subjectMax(s)}</small></div></th>`).join('')}
