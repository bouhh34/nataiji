...
function patchProfileRole(){
 ...
 if(currentUser.role==='admin'&&!currentUser.activeSharedGrant){small.textContent=tr('مدير / صلاحيات كاملة','Directeur / Accès complet');return}
