...
function tabs(){return `<div class="auth2-tabs" style="grid-template-columns:repeat(2,1fr)"><button data-auth2="login" class="${authMode==='login'?'on':''}">${tr('تسجيل الدخول','Connexion')}</button><button data-auth2="register" class="${authMode==='register'?'on':''}">${tr('إنشاء حساب','Créer un compte')}</button></div>`}
