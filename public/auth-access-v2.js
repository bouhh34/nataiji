...
let timer;function refreshAll(){const legacy=q('#joinCodeBtn');if(legacy)legacy.remove();bindSchools();bindJoinCard();bindInvite();bindLogout();enforcePermissions();patchProfileRole();patchOfficialWording();patchSettingsModal()}
